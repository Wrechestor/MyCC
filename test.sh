...
assert 0    'int printf();int main(){printf("Hello, World!\n"); return 0;}'
...
assert 2    'int printf();char a[] = "ABCDEF!";int main(){printf("%s", a);return a[3] - a[1];}'
assert 2    'int printf();int main(){char a[] = "ABCDEF!";printf("%s", a);return a[3] - a[1];}'
assert 0    'int printf();int main(){int i;for(i=0;i<20;i=i+1){if((i&7)==3 || (i&7)==5)printf("%d ",i);}return 0;}'
assert 45   'int main(){int s=0;int i;for(i=0;i<10;s+=i,i+=1);return s;}'
assert 0    'int printf();int main(){int i;for(i=0;i<20;++i){printf("%d ",i % 5);}return 0;}'
assert 0    'int printf();int main(){int i;for(i=0;i<8;++i){printf("%d,%d ",1<<i,1710581>>i);}return 0;}'
assert 0    'int printf();int main(){int i;for(i=0;i<10;++i){if(!(i%5))printf("%d ",i);}return 0;}'
assert 0    'int printf();int main(){int i=0;printf("%d ",i++);printf("%d ",++i);return 0;}'
assert 0    'int printf();int main(){int i;for(i=0;i<10;++i){printf("%s ",(i%3==0?"Fizz":"Buzz"));}return 0;}'
...
assert 0    'int printf();int main(){int i;for(i=0;i<10;++i){if(i%3==0)continue;printf("%d ",i);}return 0;}'
assert 0    'int printf();int main(){int i;int j;for(i=0;i<5;++i){for(j=0;j<10;++j){if(j%3==0)continue;if(j==7)break;printf("%d ",i*100+j);}}return 0;}'
assert 0    'int printf();int main(){int day=3;for(day=0;day<10;++day){switch(day){case 1:case 2:case 3:case 4:case 5:printf("平日 ");break;case 6:case 7:printf("週末 ");break;default:printf("無効な日付 ");}}return 0;}'
