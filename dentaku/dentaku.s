...
### 322    return 0;
  ...
  ret
.text
### 325    Node *new_node(NodeKind kind, Node *lhs, Node *rhs) {
  .globl new_node
...
new_node:
  ...
  push rdx
  sub rsp, 8
### 326    Node *node = calloc(1, sizeof(Node));
### 326    Node *node = calloc(1, sizeof(Node));
  push rax
  pop rax
  mov rax, rbp
...
new_node_num:
  ...
  push rdi
  sub rsp, 8
### 334    Node *node = calloc(1, sizeof(Node));
### 334    Node *node = calloc(1, sizeof(Node));
  push rax
  pop rax
  mov rax, rbp
...
### 362    node = calloc(1, sizeof(Node));
  ...
  push rdi
  pop rax
### 364    Token *ret_type = consume_type(TK_INT);
### 364    Token *ret_type = consume_type(TK_INT);
  push rax
  pop rax
  mov rax, rbp
...
### 369    Token *funcname;
  push rax
  pop rax
### 370    funcname = consume_type(TK_IDENT);
  mov rax, rbp
  sub rax, 24
  push rax
  push r15
...
.Lcontinue62:
  ...
  cmp rax, 0
  je  .Lend62
### 385    argtype = consume_type(TK_INT);
  mov rax, rbp
  sub rax, 40
  push rax
  push r15
...
.Lendif63:
  push rax
  pop rax
### 391    Type *type = calloc(1, sizeof(Type));
### 391    Type *type = calloc(1, sizeof(Type));
  push rax
  pop rax
  mov rax, rbp
...
.Lcontinue64:
  ...
  cmp rax, 0
  je  .Lend64
### 394    Type *t = calloc(1, sizeof(Type));
### 394    Type *t = calloc(1, sizeof(Type));
  push rax
  pop rax
  mov rax, rbp
...
.Lend64:
  push rax
  pop rax
### 400    argname = consume_type(TK_IDENT);
  mov rax, rbp
  sub rax, 32
  push rax
  push r15
...
### 407    tmp2->kind = ND_VALDEF;
  ...
  push rdi
  pop rax
### 408    LVar *lvar = find_lvar(argname);
### 408    LVar *lvar = find_lvar(argname);
  push rax
  pop rax
  mov rax, rbp
...
### 415    lvar->len = argname->len;
  ...
  push rdi
  pop rax
### 416    lvar->offset = (locals ? locals->offset : 0) + 8;
  mov rax, rbp
  sub rax, 80
  push rax
  pop rax
...
### 432    expect("{");
  ...
  push rax
  pop rax
### 433    Node *tmp = calloc(1, sizeof(Node));
### 433    Node *tmp = calloc(1, sizeof(Node));
  push rax
  pop rax
  mov rax, rbp
...
### 487    node->kind = ND_VALDEF;
  ...
  push rdi
  pop rax
### 490    Type *type = calloc(1, sizeof(Type));
### 490    Type *type = calloc(1, sizeof(Type));
  push rax
  pop rax
  mov rax, rbp
...
.Lend77:
  push rax
  pop rax
### 499    Token *tok = consume_type(TK_IDENT);
### 499    Token *tok = consume_type(TK_IDENT);
  push rax
  pop rax
  mov rax, rbp
...
### 524    lvar->len = tok->len;
  ...
  push rdi
  pop rax
### 525    lvar->offset = (locals ? locals->offset : 0) + 8 * size;
  mov rax, rbp
  sub rax, 56
  push rax
  pop rax
...
### 550    if (consume_type(TK_ELSE)) {
  ...
  cmp rax, 0
  je  .Lendif84
### 551    tmp = new_node(ND_ELSE, tmp, stmt());
  mov rax, rbp
  sub rax, 16
  push rax
  push r15
...
.Lend102:
  ...
  ret
.text
### 671    Type *estimate_type(Node *node) {
  .globl estimate_type
...
### 675    if (node->kind == ND_DEREF) {
  ...
  cmp rax, 0
  je  .Lendif106
### 676    type = estimate_type(node->lhs);
  mov rax, rbp
  sub rax, 16
  push rax
  push r15
...
### 679    if (node->kind == ND_LVAR) {
  ...
  cmp rax, 0
  je  .Lendif107
### 680    LVar *lvar = 0; // 0入れておかないと初期値でおかしくなる!!
### 680    LVar *lvar = 0; // 0入れておかないと初期値でおかしくなる!!
  push rax
  pop rax
  mov rax, rbp
...
### 681    LVar *var;
  push rax
  pop rax
### 682    for (var = locals; var; var = var->next)
  mov rax, rbp
  sub rax, 32
  push rax
  mov rax, OFFSET FLAT:locals
...
.Lendif112:
  push rax
  pop rax
### 705    Type *ltype = estimate_type(node->lhs);
### 705    Type *ltype = estimate_type(node->lhs);
  push rax
  pop rax
  mov rax, rbp
  ...
  push rdi
  pop rax
### 706    Type *rtype = estimate_type(node->rhs);
### 706    Type *rtype = estimate_type(node->rhs);
  push rax
  pop rax
  mov rax, rbp
...
### 713    Node *node = unary();
  ...
  push rdi
  pop rax
### 714    Type *type = estimate_type(node);
### 714    Type *type = estimate_type(node);
  push rax
  pop rax
  mov rax, rbp
...
.Lelse117:
  ...
  cmp rax, 0
  je  .Lendif118
### 723    int arrsize = type->array_size;
### 723    int arrsize = type->array_size;
  push rax
  pop rax
  mov rax, rbp
...
### 736    return brackets();
  ...
  ret
.text
### 739    Node *brackets() { // TODO:配列アクセス(優先順位は?)
  .globl brackets
...
### 743    if (consume("[")) {
  ...
  cmp rax, 0
  je  .Lendif123
### 745    node = new_node(ND_DEREF, new_node(ND_ADD, node, expr()), 0);
  mov rax, rbp
  sub rax, 8
  push rax
  push r15
...
.Lendif124:
  push rax
  pop rax
### 761    Token *tok = consume_type(TK_IDENT);
### 761    Token *tok = consume_type(TK_IDENT);
  push rax
  pop rax
  mov rax, rbp
...
.Lcontinue128:
  ...
  cmp rax, 0
  je  .Lend128
### 775    Node *tmp = calloc(1, sizeof(Node));
### 775    Node *tmp = calloc(1, sizeof(Node));
  push rax
  pop rax
  mov rax, rbp
...
.Lendif125:
  push rax
  pop rax
### 801    return new_node_num(expect_number());
  push r15
  push r15
  mov rax, 0
  mov r15, rsp
...
### 839    if (node->kind == ND_FUNCDEF) {
  ...
  cmp rax, 0
  je  .Lendif134
### 840    strncpy(name, node->name, node->val);
  push r15
  mov rax, rbp
  sub rax, 8
  push rax
...
### 1059    rsp_aligned = !rsp_aligned;
  ...
  push rdi
  pop rax
### 1061    int addsize = 1; // intへのポインタのとき4, ポインタへのポインタのとき8
### 1061    int addsize = 1; // intへのポインタのとき4, ポインタへのポインタのとき8
  push rax
  pop rax
  mov rax, rbp
  ...
  push rdi
  pop rax
### 1062    type = estimate_type(node->lhs);
  mov rax, rbp
  sub rax, 2080
  push rax
  push r15
...
.Lelse155:
  ...
  cmp rax, 0
  je  .Lendif158
### 1075    int arrsize = type->array_size;
### 1075    int arrsize = type->array_size;
  push rax
  pop rax
  mov rax, rbp
...
### 1138    program();
  ...
  push rax
  pop rax
### 1141    printf(".intel_syntax noprefix\n");
  push r15
...
.Lbegin165:
  ...
  cmp rax, 0
  je  .Lend165
### 1148    if (code[i] && code[i]->kind == ND_FUNCDEF) {
  mov rax, OFFSET FLAT:code
  push rax
  mov rax, rbp
  sub rax, 2072
...
.Lendif168:
  push rax
  pop rax
### 1153    strncpy(name, code[i]->name, code[i]->val);
  push r15
  mov rax, OFFSET FLAT:code
  push rax
  mov rax, rbp
